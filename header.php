                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        <div class="nav-item dropdown">
                            <!-- Message -->
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="dashboard.php" id="2"
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="member/listmember.php" class="message-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown"
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            <!-- Message -->
                                            <a href="member/occupation.php" class="message-item">
                                            ...
                                            <a href="member/qualification.php" class="message-item">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" id="2"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="font-22 mdi mdi-email-outline"></i><p>Label</p>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="image/profile.webp" alt="user" class="rounded-circle" width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="image/profile.webp" alt="user" class="rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                                ...
                                <div class="p-l-30 p-10">
                                    <a href="user/viewuser.html" class="btn btn-sm btn-success btn-rounded">View
                                        User</a>
                                </div>
                            </div>
                        </li>
