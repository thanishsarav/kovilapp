        ...
        <div class=" col-xlg-900 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="tab-content" id="userContent">
                    <div class="tab-pane fade show active col-md-12" id="profile" role="tabpanel"
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <div class="card  card-hover">
                                    <div class="card-header bg-primary">
                                        <h4 class="m-b-0 text-white">others</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="container-fluid">
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="card bg-default" width="100%">
                                    <div class="card-body">
                    ...
                    <div class="tab-pane fade show active col-md-12" id="donation" role="tabpanel"
                        aria-labelledby="pills-timeline-tab">
                        <div class="card-body">
                            <div class="table-responsive">
